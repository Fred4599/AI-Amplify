...
export function CardStack<T extends CardStackItem>({
  ...
  const stageHeight = Math.max(320, cardHeight + 80);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="pointer-events-none absolute inset-x-0 top-6 mx-auto h-48 w-[70%] max-w-md rounded-full bg-black/5 blur-3xl dark:bg-white/5"
          aria-hidden="true"
        />
        <div
          className="pointer-events-none absolute inset-x-0 bottom-0 mx-auto h-40 w-[76%] max-w-md rounded-full bg-black/10 blur-3xl dark:bg-black/30"
          aria-hidden="true"
        />
        ...
        <div className="mt-6 flex items-center justify-center gap-3">
            ...
            {items.map((it, idx) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "h-2 w-2 rounded-full transition touch-manifest",
                    on
                      ? "bg-white"
          ...
          {activeItem.href ? (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="text-neutral-400 hover:text-white transition touch-manifest"
